...
class SimGCL_int(BaseModel):
    def __init__(self, data_handler):
        super(SimGCL_int, self).__init__(data_handler)
    ...
    def cal_loss(self, batch_data):
        ...
        user_embeds3, item_embeds3, iaa_embeds = self.forward(self.adj, perturb=False)
    ...
    def full_predict(self, batch_data):
        user_embeds, item_embeds, _ = self.forward(self.adj, False)
        self.is_training = False
