...
class BIGCF_gene(BaseModel):
    def __init__(self, data_handler):
        super(BIGCF_gene, self).__init__(data_handler)
    ...
    def cal_loss(self, batch_data):
        ...
        loss = mf_loss + reg_loss + cl_loss + recon_loss + cen_loss
        losses = {'mf_loss': mf_loss, 'reg_loss': reg_loss, 'recon_loss': recon_loss, 'cl_loss': cl_loss, 'cen_loss': cen_loss}
        return loss, losses
